...
export default {
	...
	theme: {
		...
		extend: {
			...
			fontSize: {
				'heading-1': ['220px', { lineHeight: '1.1', fontWeight: '900' }],
				'heading-2': ['180px', { lineHeight: '1.1', fontWeight: '900' }],
				'title': ['105px', { lineHeight: '1.1', fontWeight: '700' }],
				'subtitle': ['50px', { lineHeight: '1.2', fontWeight: '400' }],
			},
			colors: {
