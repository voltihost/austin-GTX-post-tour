      ...
      <div className="w-full max-w-7xl mx-auto px-4 py-6 md:py-8">
        <div className="text-center mb-6 md:mb-8">
          <div className="flex items-center justify-center mb-4 md:mb-6">
            <img src={companyLogos.main} alt="Get Up And Go Kayaking Logo" className="h-40 md:h-56 w-auto drop-shadow-xl cursor-pointer hover:scale-105 transition-transform" onClick={handleLogoClick} loading="lazy" />
          </div>
          <div className="max-w-2xl mx-auto px-4">
            <h1 className="text-2xl font-bold mb-6 md:mb-8 leading-tight text-zinc-950 md:text-2xl">
