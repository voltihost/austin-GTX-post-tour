...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-water-light/40 via-white to-water-light/30">
      {/* Header with Logo */}
      <div className="w-full max-w-7xl mx-auto px-4 py-6 md:py-8">
        <div className="text-center mb-6 md:mb-8">
          ...
          <div className="max-w-2xl mx-auto px-4">
            <h1 className="text-2xl md:text-4xl font-bold text-forest mb-3 md:mb-4 leading-tight">
              Thank You for an Amazing Adventure! 🌊
            </h1>
            <p className="text-lg md:text-xl text-forest/80 mb-6 md:mb-8 leading-relaxed">
      ...
      <div className="bg-gradient-to-r from-forest/95 to-water-deep/95 py-12 md:py-16">
